...
for i in range(len(reftranslation)):
    ...
    #f=open("WEEM.seg.score","a+")
    #f.write("\nWEEM\tru-en\tnewstest2015\tonline-E.0\t" + str(i+1) + "\t" + str(WEEMscore))
    #f.close()
    
    #wmt19  <METRIC NAME>   <LANG-PAIR>   <TEST SET>   <SYSTEM>   <SEGMENT NUMBER>   <SEGMENT SCORE> <ENSEMBLE>   <AVAILABLE>
    f=open("WEEM.seg.score","a+")
    f.write("\nWEEM\tru-lt\tnewstest2019\tonline-E.0\t" + str(i+1) + "\t" + str(WEEMscore) + "\tnon-ensemble" + "\tno")
    f.close()
...
f.write("\nWEEM\tcs-lt\tnewstest2019\tonline-G.0\t" + str(resultantscore) + "\t" + "\tnon-ensemble" + "\tno")
f.close()
...
#f=open("WEEM.sys.score","a+")
#f.write("\nWEEM\tru-en\tnewstest2015\tonline-E.0\t" + str(resultantscore))
#f.close()
